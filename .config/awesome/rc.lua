...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "space",     function () 
        awful.util.spawn("rofi -lines 12 -padding 18 -width 60 -location 0 -show drun -sidebar-mode -columns 2 -font 'Jetbrains mono 10' -theme gruvbox-dark") end,
            {description = "run prompt", group = "launcher"}),

    -- Applications
    awful.key({ modkey },            "e",     function ()
        awful.util.spawn("thunar") end,
            {description = "Open Thunar", group = "applications"}),
    ...
    awful.util.spawn("logseq") end,
            {description = "Open Logseq", group = "applications"}),

    awful.key({ modkey },            "z",     function ()
        awful.util.spawn("pavucontrol") end,
                {description = "Open volume control", group = "applications"}),

    awful.key({ modkey },            "a",     function ()
        awful.util.spawn("audacious") end,
                {description = "Open Audacious", group = "applications"}),

    awful.key({ modkey, "Shift" },            "s",     function () 
        awful.util.spawn({"flameshot", "gui"}) end,
                {description = "Take screenhost with flameshot", group = "applications"}),
    ...
    awful.key({ modkey },            "-",     function ()
        awful.util.spawn({"audacious", "-u"}) end,
            {description = "Next track", group = "media"}),
    -- awful.key({ modkey, "Shift" },            "s",     function () 
    --     awful.util.spawn("kitty -e flameshot gui") end,
    --             {description = "Take screenhost with flameshot", group = "applications"}),
    -- awful.key({ modkey }, "x",
    --           function ()
    --               awful.prompt.run {
...
awful.spawn "jack_control start"
