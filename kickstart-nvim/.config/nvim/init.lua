...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      require('everblush').setup {
        ...
        override = {
          LineNr = { fg = '#A9A9A9' }, -- clearer line numbers
        },
      }
  ...
  },
  {
    ...
    config = function()
      require('lualine').setup {
        ...
        sections = {
          lualine_c = {
            { 'filename', path = 3 }, -- Shows absolute path
          },
        },
      }
    end,
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'go', 'helm', 'norg' },
